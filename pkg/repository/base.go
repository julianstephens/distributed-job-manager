...
func (r *Repository) getFilteredQuery(query map[string][]string, tableName string, validColumns []string) (*gocqlx.Queryx, error) {
	var values []any
	...
	return r.DB.Client.Query(stmt, names).Bind(values...), nil
}
