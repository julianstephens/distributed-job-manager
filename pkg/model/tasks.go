...
type Task struct {
	ID            string         `faker:"uuid_digit" json:"id" dynamodbav:"id" binding:"-"`
	...
	CreatedAt     int64          `faker:"unix_time" json:"createdAt" dynamodbav:"createdAt" binding:"-"`
	UpdatedAt     int64          `faker:"unix_time" json:"updatedAt" dynamodbav:"updatedAt" binding:"-"`
